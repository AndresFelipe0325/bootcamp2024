...
class MainActivity : AppCompatActivity() {
    ...
    private suspend fun downloadUserData() {
        for (i in 1..200000) {
            ...
            /** Switching Coroutines scopes from IO to Main in order to set values on
             * views
             *
             * NOTE: we added the suspend keyword in the function declaration because "withContext
             * method only can be called by suspend functions**/
